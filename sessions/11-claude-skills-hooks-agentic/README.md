...
Server build). Strong candidate to split into two 1hr parts:
- **Part A:** Claude Skills, Claude Hooks, Githooks (concepts + comparison)
- **Part B:** Agentic loops + building a minimal MCP server (hands-on build,
  needs the most lab time of anything in this block)
